<x-app-layout>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <form action="{{ route('organizations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
                    <label class="block text-sm font-medium text-gray-700">Name</label>
                    <input type="text" name="name" required class="mt-1 w-full rounded-lg border-gray-300" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="address" class="mt-1 w-full rounded-lg border-gray-300"></textarea>
                </div>
                <div>
